...
--
-- Hôte : localhost
-- Généré le : lun. 17 nov. 2025 à 15:42
...
--
-- Base de données : `application-paris-sportifs`
--
...
(100, 'PSG', 'OM', '2025-11-17 14:47:05', 10),
(101, 'Lakers', 'Bulls', '2025-11-17 14:47:47', 11),
(102, 'Nadal', 'Federer', '2025-11-17 14:48:02', 12);
...
(77, 1, 100, 200, 20.00, '20'),
(78, 3, 101, 201, 15.00, '15'),
(79, 2, 102, 203, 10.00, '10');
...
(1, 'DUPONT', 'Marc', 'dupont.marc@gmail.com'),
...
--
ALTER TABLE `gain`
  MODIFY `id_gain` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT pour la table `matchs`
--
ALTER TABLE `matchs`
  MODIFY `id_match` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT pour la table `pari`
--
ALTER TABLE `pari`
  MODIFY `id_pari` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT pour la table `sport`
--
ALTER TABLE `sport`
  MODIFY `id_sport` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `typepari`
--
ALTER TABLE `typepari`
  MODIFY `id_typepari` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
